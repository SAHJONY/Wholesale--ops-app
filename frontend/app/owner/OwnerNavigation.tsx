...
const primary: NavItem[] = [
  ...
  { href: '/owner/acquisition', label: 'Acquisitions', icon: '↗' },
  { href: '/owner/deals', label: 'Deals', icon: '◇' },
  { href: '/owner/communications', label: 'Communications', icon: '◌' },
  { href: '/owner/disposition', label: 'Disposition', icon: '◎' },
];

const intelligence: NavItem[] = [
  { href: '/owner/real-estate-intelligence', label: 'Property intelligence', icon: '◆' },
  { href: '/owner/nationwide-data', label: 'Verified public data', icon: '✓' },
...
const operations: NavItem[] = [
  ...
  { href: '/owner/closing', label: 'Closing', icon: '□' },
  { href: '/owner/jobs', label: 'Automation jobs', icon: '↻' },
  { href: '/owner/integrations', label: 'Integrations', icon: '+' },
  { href: '/owner/system-health', label: 'System health', icon: '●' },
  { href: '/owner/security', label: 'Security', icon: '⌾' },
];
  ...
  return <>
    ...
    <aside id="owner-navigation" className={`ownerNav ${open ? 'open' : ''}`}>
      ...
      <nav aria-label="Owner workspace">
        <LinkGroup label="Workspace" items={primary} pathname={pathname} onNavigate={() => setOpen(false)} />
